export default [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_liquidityCap", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_prizeStrategy", type: "address" },
    ],
  ...
  },
  {
    ...
    name: "yieldSource",
    outputs: [
      { internalType: "contract IYieldSource", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
